...
{   public:
        ...
        void initTab(Ship& c1, Ship& c2, Ship& c3, Ship& s1, Ship& s2, Ship& s3, Ship& e1, Ship& e2, std::ofstream& file);
        void auto_initTab(Ship& c1, Ship& c2, Ship& c3, Ship& s1, Ship& s2, Ship& s3, Ship& e1, Ship& e2, std::ofstream& file);
        ...
        void delete_ships(Ship& ship, Tab_dif& tabella_difesa, std::list<Ship>& lista_navi);
        std::list<Ship> lista_navi;
        friend Ship;
    private:
